{{--
    FILE: resources/views/livewire/front/seller-verify-otp.blade.php
    Component: App\Livewire\Front\SellerVerifyOtp
    Route: GET /seller/verify-email  →  name('seller.verify.otp')
--}}

@push('custom-meta')
<title>Verify Your Email – GlobPulse Seller</title>
<style>
...
<div>
        ...
        <div class="otp-wrap">
            ...
            <div class="otp-right">
                ...
                <form wire:submit.prevent="verifyOtp">
                    ...
                    <div class="otp-boxes">
                        ...
                        <input type="number" class="otp-box" wire:model="d4" maxlength="1" min="0" max="9"
                            id="otp4" oninput="otpMove(this,'')"    onkeydown="otpBack(event,this,'otp3')">
                    </div>
                ...
                <p style="font-size:12px;color:#94a3b8;text-align:center;margin-top:14px">
                    Wrong email?
                    <a href="{{ route('seller.register') }}" style="color:#2563eb;font-weight:700;text-decoration:none">Go back and re-register</a>
                </p>
            </div>
    ...
    document.querySelector('.otp-boxes').addEventListener('paste', function(e) {
        ...
        if (digits.length === 4) boxes[3].focus();
    });
