{{--
    FILE: resources/views/livewire/front/seller-login.blade.php
    Component: App\Livewire\Front\SellerLogin
    Route: GET /seller/login  →  name('seller.login')
--}}

@push('custom-meta')
<title>Seller Login – GlobPulse</title>
<style>
...
<div>
        ...
        <div class="sl-wrap">
            ...
            <div class="sl-left">
                ...
                <div class="sl-left-body">
                    ...
                    <p>Access your seller dashboard to manage products, view buyer inquiries and grow your global trade.</p>
                    <div class="sl-perk"><div class="sl-perk-dot">🎯</div><span>AI-matched buyer inquiries</span></div>
                    <div class="sl-perk"><div class="sl-perk-dot">📊</div><span>Real-time sales analytics</span></div>
                    <div class="sl-perk"><div class="sl-perk-dot">🌍</div><span>Reach buyers in 180+ countries</span></div>
                    <div class="sl-perk"><div class="sl-perk-dot">🏅</div><span>Verified seller badge</span></div>
                </div>
                <div class="sl-left-foot">
                    New to GlobPulse? <a href="{{ route('seller.register') }}">Create free account →</a>
                </div>
            </div>
            ...
            <div class="sl-right">
                ...
                {{-- Success from OTP verification --}}
                @if(session('login_success') || $successMsg)
                    <div class="sl-alert success">
                        <span>✅</span>
                        <span>{{ session('login_success') ?? $successMsg }}</span>
                    </div>
                @endif

                <div class="sl-head">
                    <h2>Sign in to your account</h2>
                    <p>Enter your credentials to access your seller dashboard</p>
                </div>
                ...
                <form wire:submit.prevent="login">
                    ...
                    <div class="sl-fg">
                        ...
                        <input type="email" class="sl-input" wire:model="email"
                    ...
                    <div class="sl-fg">
                        ...
                        <div class="sl-pw-wrap">
                            <input type="password" class="sl-input" wire:model="password"
                                placeholder="Enter your password"
                                id="sl-pw" autocomplete="current-password">
                            <button type="button" class="sl-pw-toggle" onclick="slTogglePw()">
                                <svg id="sl-eye-show" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/><circle cx="12" cy="12" r="3"/></svg>
                                <svg id="sl-eye-hide" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="display:none"><path d="M17.94 17.94A10.07 10.07 0 0112 20c-7 0-11-8-11-8a18.45 18.45 0 015.06-5.94M9.9 4.24A9.12 9.12 0 0112 4c7 0 11 8 11 8a18.5 18.5 0 01-2.16 3.19m-6.72-1.07a3 3 0 11-4.24-4.24"/><line x1="1" y1="1" x2="23" y2="23"/></svg>
                            </button>
                        </div>
                    ...
                    <div class="form-check mb-4">
                        ...
                        <label class="form-check-label small" for="sl-remember">Remember me on this device</label>
                    </div>
                ...
                <div class="sl-divider"><span>New to GlobPulse?</span></div>
                <a href="{{ route('seller.register') }}" class="btn-sl-register">
    ...
    function slTogglePw() {
        ...
        if (pw.type === 'password') {
            pw.type = 'text'; show.style.display='none'; hide.style.display='block';
        } else {
            pw.type = 'password'; show.style.display='block'; hide.style.display='none';
        }
    }
    </script>
</div>