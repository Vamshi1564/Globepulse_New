{{-- FILE: resources/views/livewire/front/buyer-forgot-password.blade.php --}}

@push('custom-meta')
<title>Reset Password – GlobPulse Buyer</title>
<style>
...
<span wire:loading.remove wire:target="sendResetOtp">
📧 Send Reset Code
</span>

<span wire:loading wire:target="sendResetOtp">
...
<div class="fp-resend">
<button type="button" wire:click="resendResetOtp">
Resend code
</button>
</div>
...
<svg id="fp-ea" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
<path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
<circle cx="12" cy="12" r="3"/>
</svg>

<svg id="fp-eb" width="17" height="17" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="display:none">
...
<button type="button" class="btn-fp-back" wire:click="goBack">
← Back
</button>
