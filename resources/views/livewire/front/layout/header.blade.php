                    ...
                    <div class="row gx-0 gy-2 w-100 flex-between-center">
                        <div class="col-6 col-sm-2 col-md-4 col-lg-3"><a class="text-decoration-none"
                                ...
                                <div class="d-flex align-items-center">
                                    <img class="w-100" src="../../../assets/img/logos/GFEPLUSE.png" alt="phoenix" />
                                    <!-- <h5 class="logo-text fs-7 text-sm-wrap bg-GFE fw-bold fs-sm-6 ms-2">GFE Business</h5> -->
                                </div>
                            </a>
                        </div>
                        <div class="col-6 col-sm-2 col-md-3 col-lg-3 order-0 order-md-0 order-lg-1">
                            <ul class="navbar-nav navbar-nav-icons justify-content-end flex-row me-n2">
                              ...
                              data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false"><span
                                class="text-body-tertiary" data-feather="user" style="height:20px;width:20px;"></span></a> -->
                                    <!-- <span class="nav-link px-2 w-25" id="navbarDropdownUser" role="button" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
        
                                  <img src="../../../assets/img/team/india.webp" class="ab" alt="">
                                </span> -->
                                    <a class="nav-link px-2" id="navbarDropdownUser" href="#" role="button"
                                        data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true"
                                        aria-expanded="false">
                                        <div class="text-center">
                                            <h6 class="fs-9">Deliver to</h6>
                                            <div class="d-flex align-items-center justify-content-center">
                                                <span class="w-25">
                                                    <img src="../../../assets/img/team/india.gif" class="w-100" alt="">
                                                </span>
                                                <span class="ms-1 fs-9 text-black fw-bold">India</span>
                                            </div>
                                        </div>
                                    </a>
                                    <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 w-50 dropdown-profile shadow border mt-2"
                                                ...
                                                <div class="text-center pt-4 pb-3">
                                                    <div class="avatar avatar-xl ">
                                                        <img class="rounded-circle "
                                                            src="../../../assets/img/team/india.jpeg" alt="" />

                                                    </div>
                                                    <h6 class="mt-2 text-body-emphasis">INDIA</h6>
                                                </div>
                                                <div class="mb-3 mx-5">
                                                    <div class="form-group ">
                                                        <form action="">
                                                            <select id="country">
                                                                ...
                                                                <!-- <div class="text-center">
                                            <p id="fallback-message" class="fallback fw-bold fs-7">No Result Found.</p>
                                          </div> -->
                                                                <option id="fallback-message" class="d-none" disabled>
                                                                    No
                                                                    Result Found.</option>
                                                            ...
                                                            <div class="mt-3">
                                                                <button type="submit"
                                                                    class="btn btn-phoenix-secondary bg-warning-light d-flex flex-center w-100">Save</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
...
@endif
    ...
    <nav class="ecommerce-navbar navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <!-- Category Dropdown -->
            <div class="dropdown position-relative">
                <button class="btn ps-0 pe-5 text-nowrap dropdown-toggle dropdown-caret-none text-"
                    id="categoryDropdown">
                    <span class="fas fa-bars me-2 text-dark"></span> Category
                </button>
            ...
            <div id="subcategoryPanel" class="position-absolute d-none bg-white shadow-lg p-3 rounded"
                style="width: 100%; max-width: 300px; left: 295px; top: 35px; z-index: 9999;">
...
background:#f3f4f6;
            ...
            <div>
                ...
                <div class="d-lg-none">
                    <a class="fs-9  me-3 text-dark" href="{{ route('home') }}">Home</a>
                    <!-- More Dropdown for mobile/tablet screens -->
                    <div class="dropdown ">
                        <div class="d-flex ">
                            <a class="fs-9 nav-link dropdown-toggle text-dark" href="#" id="navbarDropdown"
                        ...
                        <ul class="dropdown-menu droplinks-1" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="{{ route('postbyrequirement') }}"
                                    wire:click.prevent="redirectToPostByRequirement">Post Buy Requirements</a></li>
                            @if (!session('id'))
                                <li><a class="dropdown-item" href="{{ route('signup') }}">Become Supplier</a></li>
                            @else
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ">
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('packages') }}">Membership Plans</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('byleads') }}">Buy Leads</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('hotdeal') }}">Hot Deals</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('postbyrequirement') }}"
                                wire:click.prevent="redirectToPostByRequirement">Post Buy Requirements</a>
                        </li>
                        @if (!session('id'))
                            <li class="nav-item">
                                <a class="nav-link text-dark" href="{{ route('signup') }}">Become Supplier</a>
                            </li>
                        @else
                            <li class="nav-item">
                                <a class="nav-link text-dark" href="{{ route('product_add') }}"
                        ...
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="{{ route('trade-finance-solutions') }}">Trade
                                Finance</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-dark" href="https://gfecci.org" target="_blank">GFE Chamber</a>
                        </li>
                    </ul>
                </div>
            </div>
