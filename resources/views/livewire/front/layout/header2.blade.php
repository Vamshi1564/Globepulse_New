                                ...
                                @if (!empty(session('id')))
                                    <li class="nav-item dropdown">
                                        <a class="nav-link px-2" id="navbarDropdownUser" href="#" role="button"
                                            ...
                                            aria-expanded="false"><span class="text-body-tertiary avatar avatar-xl "
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border mt-2"
                                            ...
                                            <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                                                <div class="card-body p-4 text-center">
                                                    ...
                                                    @if ($customer)
                                                        <h6 class="mt-3 fw-semibold text-dark">{{ $customer->name }}
                                                        </h6>
                                                    @else
                                                        <h6 class="mt-3 fw-semibold text-dark">Guest User</h6>
                                                    @endif
