{{-- FILE: resources/views/livewire/front/buyer-set-password.blade.php --}}
{{-- Component: App\Livewire\Front\BuyerSetPassword --}}
{{-- Route: GET /buyer/set-password → name('buyer.set-password') --}}

@push('custom-meta')
<title>Set New Password – GlobPulse Buyer</title>
<style>
    ...
    <div class="sp-page px-3">
        <div class="sp-card">
            <div class="sp-header">
                ...
                <p>Hi {{ $buyerName }}! Choose a strong password to secure your buyer account</p>
            </div>
            <div class="sp-body">
