{{-- 
FILE: resources/views/livewire/front/buyer-register.blade.php
Component: App\Livewire\Front\BuyerRegister
Route: GET /buyer/register → name('buyer.register')
--}}
@push('custom-meta')
<title>Buyer Registration – GlobPulse</title>
...
<h2>Find <em>trusted suppliers</em> worldwide</h2>

<p>
Join GlobPulse buyers network and connect with verified manufacturers,
exporters and wholesalers across 50+ countries.
</p>
...
<p>Enter your basic contact details</p>
</div>
</div>
...
<div class="sr-step-text">
<h5>Start sending inquiries</h5>
<p>Contact suppliers instantly</p>
</div>
</div>
...
<a href="{{ route('buyer.login') }}">Sign in →</a>
</div>
...
Have account?
<a href="{{ route('buyer.login') }}" style="color:#2563eb;font-weight:700;text-decoration:none">
Sign in
</a>
</span>
...
Start sourcing products from global suppliers
</p>
</div>
...
<select class="form-select" wire:model="country_code">
...
<button type="submit" class="btn-sr-submit">
...
Free buyer account · Contact suppliers directly
</p>
