<div>
    <form class="position-relative" wire:submit.prevent="submitSearch">
        <div class="search-container">
            <div class="search-bar">
                <select class="my-select1 selectpicker border-0" wire:model="searchType" data-container="body">
                    <option value="product">Product</option>
                    <option value="buylead">BuyLead</option>
                </select>
                <input type="text" wire:model="searchTerm" class="search-input11" placeholder="Search..." />
