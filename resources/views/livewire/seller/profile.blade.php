...
<livewire:seller.layout.header />
            ...
            <div class="av-wrap">
              ...
              @else
                ...
                @php
                  ...
                  $initials = strtoupper(implode('', array_map(fn($w) => $w[0], array_slice(explode(' ', trim($bname)), 0, 2))));
                @endphp
                <div class="av-img" style="background:linear-gradient(135deg,#1a56db,#0e9f6e);display:flex;align-items:center;justify-content:center;color:#fff;font-size:1.4rem;font-weight:800;letter-spacing:1px;">
                  {{ $initials }}
                </div>
              @endif
                  ...
                  <div class="col-md-6">
                    <div class="fg">
                      ...
                      <div class="duz">
                        ...
                        @else
                        <div class="text-center py-1" id="logo-preview-wrap">
                          <i class="fas fa-image text-muted" style="font-size:1.2rem;" id="logo-placeholder"></i>
    ...
    function previewLogo(input) {
        ...
        reader.onload = function(e) {
            if (wrap) {
                wrap.innerHTML = '<img src="' + e.target.result + '" style="max-height:80px;max-width:180px;object-fit:contain;border-radius:8px;border:1.5px solid #e5e9f2;padding:6px;background:#fff;" alt="Logo Preview"><div class="duz-hint mt-1" style="color:#1a56db;font-weight:600;"><i class="bi bi-image me-1"></i>' + file.name + '</div>';
            }
        };
        reader.readAsDataURL(file);
    }
