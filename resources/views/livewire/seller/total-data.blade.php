                            ...
                            <table class="table fs-9 mb-0">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="sort white-space-nowrap align-middle ps-4" scope="col"
                                            style="width:350px;" data-sort="product">HSN Code</th>
                                        <th class="sort align-middle text-end ps-4" scope="col" data-sort="price"
                                            style="width:150px;">No. Of Leads</th>
                                        <th class="sort align-middle text-end ps-4" scope="col" data-sort="price"
                                            style="width:150px;">Download</th>
                                        {{-- <th class="sort align-middle text-end ps-4" scope="col" data-sort="price"
                                ...
                                <tbody class="list" id="products-table-body">
                                    ...
                                    <tr class="position-static">
                                        ...
                                        {{-- <td class="align-middle white-space-nowrap py-0"><a
                                                ...
                                                href="../../../apps/e-commerce/landing/product-details.html"><img
                                                    ...
                                                    width="53" /></a></td> --}}
                                        <td class="product align-middle ps-4">07031020</td>
                                        <td
                                            class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            9</td>
                                            <td
                                            class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            <a href="../../../assets/1511data.xlsx" download="1511data.xlsx">
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="product align-middle ps-4">0325557</td>
                                        <td class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">12</td>
                                        <td class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            <a href="../../../assets/ch28.xlsx" download="ch28.xlsx">
                                                <button type="button">Download</button>
                                            </a>
                                        </td>
                                    </tr>    
