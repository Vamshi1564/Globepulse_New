    ...
    <div class="content">
        <nav class="mb-5" style="--phoenix-breadcrumb-divider: '&gt;&gt;';" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active fs-sm text-dark fw-bold" aria-current="page">Suppliers and Importers
                </li>
            </ol>
        </nav>
        <div class="row gy-3 mb-4 justify-content-between">
            <div class="col-xxl-6">
                <div class="d-flex align-items-center gap-2 mb-5">
                    ...
                    <h1 class="mb-0 fw-bolder">Suppliers and Importers</h1>
                </div>
                                    ...
                                    <div class="border-translucent ">
                                        <div class="d-flex align-items-center  gap-2">
                                            ...
                                            <a href="{{ route('suppliersand-importers-informasion') }}"
                                                class="text-primary mt-2 fs-6 fw-bold mb-0 mb-sm-4">
                                                <p class="fs-8 text-body lh-lg m-0 p-0">Suppliers and Importers
                                                    information</p>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border-translucent ">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <a href="{{ route('buyer-informasion') }}"
                                                class="text-primary mt-2 fs-6 fw-bold mb-0 mb-sm-4">
                                                <p class="fs-8 text-body lh-lg m-0 p-0">Buyer information</p>
                                            </a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="border-translucent ">
                                        <div class="d-flex align-items-center  gap-2">
                                            ...
                                            <a href="{{ route('suppliers-informasion') }}"
                                                class="text-primary mt-2 fs-6 fw-bold mb-0 mb-sm-4">
                                                <p class="fs-8 text-body lh-lg m-0 p-0">Suppliers information</p>
                                            </a>
                                        </div>
                                    </div>
