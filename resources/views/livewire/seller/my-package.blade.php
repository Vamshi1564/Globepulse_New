    ...
    <div class="content">
        <nav class="mb-5" style="--phoenix-breadcrumb-divider: '&gt;&gt;';" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active fs-sm text-dark fw-bold" aria-current="page">My Package</li>
            </ol>
        </nav>
        <div class="row gy-3 mb-4 justify-content-between">
            <div class="col-xxl-6">
                <h1 class="mb-5 text-body-emphasis fw-bolder mb-5">My Package</h1>
                                        ...
                                        <div class="d-flex align-items-center  gap-2">
                                            ...
                                            <a href="{{ route('documents') }}"
                                                class="text-primary mt-2 fs-6 fw-bold mb-0 mb-sm-4"><span
                                                    class="fs-8 text-body lh-lg">My Digi Locker</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="d-flex align-items-center  gap-2">
                                            ...
                                            <a href="{{ route('project') }}"
                                                class="text-info mt-2 fs-6 fw-bold mb-0 mb-sm-4"><span
                                                    class="fs-8 text-body lh-lg">Delivery Status</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="border-translucent ">
                                        <div class="d-flex align-items-center  gap-2">
                                            ...
                                            <a href="{{ route('invoice-list') }}"
                                                class="text-info mt-2 fs-6 fw-bold mb-0 mb-sm-4"><span
                                                    class="fs-8 text-body lh-lg">My Receipts</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="d-flex align-items-center  gap-2">
                                            ...
                                            <a href="https://lms.gfebusiness.org/home/lesson/export-import-training/8"
                                                target="_blank" class="text-info mt-2 fs-6 fw-bold mb-0 mb-sm-4"><span
                                                    class="fs-8 text-body lh-lg">My Course</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
