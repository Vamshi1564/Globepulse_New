                ...
                <ul class="navbar-nav navbar-nav-icons flex-row">
                            ...
                            <div class=" position-relative border-0">
                                <div class="card-body py-2 px-2 ">
                                    <div class="row text-center align-items-center gx-2 gy-2">
                                        ...
                                        <!-- Ticket Support -->
                                        @if (false) {{-- sellers: ticket support coming soon --}}
                                            <div class="col-4">
                    ...
                    <li class="nav-item dropdown"><a class="nav-link lh-1 pe-0" id="navbarDropdownUser" href="#!"
                            ...
                            <div class="avatar avatar-l ">
                                @if ($seller && $seller->profile_photo_url)
                                    <img class="rounded-circle w-100"
                                        src="{{ $seller->profile_photo_url }}" alt="" />
                                @else
                        ...
                        <div class="dropdown-menu dropdown-menu-end navbar-dropdown-caret py-0 dropdown-profile shadow border"
                            ...
                            <div class="card shadow-lg border-0 rounded-4 overflow-hidden">
                                <div class="card-body p-4 text-center">
                                    ...
                                    <h6 class="mt-3 fw-semibold text-dark">{{ $seller?->details?->legal_business_name ?? session("seller_name") }}</h6>
                                </div>
