        ...
        <div class="content">
            ...
            <div class="mb-9">
                <div class="row g-3 mb-4">
                    <div class="col-auto">
                        <h2 class="mb-0">Total Buylead Enquiry</h2>
                    </div>
                </div>
                ...
                <div id="products"
                        ...
                        <div class="col-auto">
                            <div class="d-flex">
                                <div class="search-box me-2">
                                    <form class="position-relative" wire:submit.prevent='searchBuyleadEnquiry'>
                                        <div class="d-flex justify-content-between">
                                            <input class="form-control search-input search" type="text"
                                                placeholder="Search by email or phonenumber" wire:model="search" />
                    ...
                    <div
                        ...
                        <div class="table-responsive scrollbar mx-n1 px-1">
                            @if ($buyleadinquiry->isNotEmpty())
                                <table class="table fs-9 mb-0 text-center">
                                    <div class="d-flex justify-content-center">
                                        <div class="my-2 text-center" wire:loading wire:target="searchBuyleadEnquiry">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sort white-space-nowrap align-middle" scope="col"
                                                style="width:150px;" data-sort="product">Customer Name</th>
                                            <th class="sort align-middle" scope="col" data-sort="price"
                                                style="width:150px;">Mobile No.</th>
                                            <th class="sort align-middle" scope="col" data-sort="price"
                                    ...
                                    <tbody class="list" id="products-table-body">
                                        ...
                                        @foreach ($buyleadinquiry as $item)
                                            <tr class="position-static">
                                                ...
                                                href="../../../apps/e-commerce/landing/product-details.html"><img
                                                    ...
                                                    width="53" /></a></td> --}}
                                                <td
                                                    class="price align-middle white-space-nowrap ps-2 fw-bold text-body-tertiary">
                                                    {{ $loop->iteration }}</td>
                                                <td
                                                    class="price align-middle white-space-nowrap fw-bold text-body-tertiary">
                                                    {{ $item->customer->name }}
                                                </td>
                                                <td
                                                    class="price align-middle white-space-nowrap fw-bold text-body-tertiary">
                                        ...
                                        <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                                ...
                                                class="text-decoration-none" href="#!"><span
                                                    class="badge badge-tag me-2 mb-2">Fitness</span></a>
                                        </td>
                                        ...
                                        <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                                ...
                                                class="text-decoration-none" href="#!"><span
                                                    class="badge badge-tag me-2 mb-2">Swag</span></a>
                                        </td>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                                ...
                                                Pro 13 inch-M1-8/256GB-space</a></td>
                                        <td
                                            class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            $9</td>
                                        <td
                                        ...
                                        <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                                ...
                                                class="text-decoration-none" href="#!"><span
                                                    class="badge badge-tag me-2 mb-2">Gray</span></a>
                                        </td>
                                        <td class="align-middle review fs-8 text-center ps-4">
                                            <div class="d-toggle-container">
                                                <div class="d-block-hover"><span class="fas fa-star text-warning"></span>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                                ...
                                                class="text-decoration-none" href="#!"><span
                                                    class="badge badge-tag me-2 mb-2">PC killer</span></a>
                                        </td>
                                        <td class="align-middle review fs-8 text-center ps-4">
                                            <div class="d-toggle-container">
                                                <div class="d-block-hover"><span class="fas fa-star text-warning"></span>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="align-middle white-space-nowrap py-0"><a
                                                ...
                                                href="../../../apps/e-commerce/landing/product-details.html"><img
                                                    ...
                                                    width="53" /></a></td>
                                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                                href="../../../apps/e-commerce/landing/product-details.html">Razer Kraken
                                                v3 x Wired 7.1 Surroung Sound Gaming headset</a></td>
                                        <td
                                            class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            $120</td>
                                        <td
                                        ...
                                        <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                                ...
                                                class="text-decoration-none" href="#!"><span
                                                    class="badge badge-tag me-2 mb-2">Sound</span></a>
                                        </td>
                                        <td class="align-middle review fs-8 text-center ps-4">
                                            <div class="d-toggle-container">
                                                <div class="d-block-hover"><span class="fas fa-star text-warning"></span>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                                ...
                                                class="text-decoration-none" href="#!"><span
                                                    class="badge badge-tag me-2 mb-2">Wireless</span></a>
                                        </td>
                                        <td class="align-middle review fs-8 text-center ps-4">
                                            <div class="d-toggle-container">
                                                <div class="d-block-hover"><span class="fas fa-star text-warning"></span>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                                ...
                                                class="text-decoration-none" href="#!"><span
                                                    class="badge badge-tag me-2 mb-2">Space</span></a>
                                        </td>
                                        <td class="align-middle review fs-8 text-center ps-4">
                                            <div class="d-toggle-container">
                                                <div class="d-block-hover"><span class="fas fa-star text-warning"></span>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                                ...
                                                class="text-decoration-none" href="#!"><span
                                                    class="badge badge-tag me-2 mb-2">Black</span></a>
                                        </td>
                                        <td class="align-middle review fs-8 text-center ps-4">
                                            <div class="d-toggle-container">
                                                <div class="d-block-hover"><span class="fas fa-star text-warning"></span>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="align-middle white-space-nowrap py-0"><a
                                                ...
                                                href="../../../apps/e-commerce/landing/product-details.html"><img
                                                    ...
                                                    width="53" /></a></td>
                                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                                href="../../../apps/e-commerce/landing/product-details.html">Apple Magic
                                                Mouse (Wireless, Rechargable) - Silver</a></td>
                                        <td
                                            class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            $568</td>
                                        <td
                                        ...
                                        <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                                ...
                                                class="text-decoration-none" href="#!"><span
                                                    class="badge badge-tag me-2 mb-2">Performance</span></a>
                                        </td>
                                        <td class="align-middle review fs-8 text-center ps-4">
                                            <div class="d-toggle-container">
                                                <div class="d-block-hover"><span class="fas fa-star text-warning"></span>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="align-middle white-space-nowrap py-0"><a
                                                ...
                                                href="../../../apps/e-commerce/landing/product-details.html"><img
                                                    ...
                                                    width="53" /></a></td>
                                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                                href="../../../apps/e-commerce/landing/product-details.html">HORI Racing
                                                Wheel Apex for PlayStation 4_3, and PC</a></td>
                                        <td
                                            class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            $17</td>
                                        <td
                                        ...
                                        <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                                ...
                                                class="text-decoration-none" href="#!"><span
                                                    class="badge badge-tag me-2 mb-2">Apex</span></a>
                                        </td>
                                        <td class="align-middle review fs-8 text-center ps-4">
                                            <div class="d-toggle-container">
                                                <div class="d-block-hover"><span class="fas fa-star text-warning"></span>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="align-middle white-space-nowrap py-0"><a
                                                ...
                                                href="../../../apps/e-commerce/landing/product-details.html"><img
                                                    ...
                                                    width="53" /></a></td>
                                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                                href="../../../apps/e-commerce/landing/product-details.html">Apple Pencil
                                                (2nd Generation)</a></td>
                                        <td
                                            class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            $28</td>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="align-middle white-space-nowrap py-0"><a
                                                ...
                                                href="../../../apps/e-commerce/landing/product-details.html"><img
                                                    ...
                                                    width="53" /></a></td>
                                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                                href="../../../apps/e-commerce/landing/product-details.html">Apple AirPods
                                                (2nd Generation)</a></td>
                                        <td
                                            class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            $20</td>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="align-middle white-space-nowrap py-0"><a
                                                ...
                                                href="../../../apps/e-commerce/landing/product-details.html"><img
                                                    ...
                                                    width="53" /></a></td>
                                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                                href="../../../apps/e-commerce/landing/product-details.html">Xbox Series
                                                S</a></td>
                                        <td
                                            class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            $30</td>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="align-middle white-space-nowrap py-0"><a
                                                ...
                                                href="../../../apps/e-commerce/landing/product-details.html"><img
                                                    ...
                                                    width="53" /></a></td>
                                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                                href="../../../apps/e-commerce/landing/product-details.html">Seagate
                                                Portable 2TB External Hard Drive Portable HDD</a></td>
                                        <td
                                            class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            $50</td>
                                        <td
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="align-middle white-space-nowrap py-0"><a
                                                ...
                                                href="../../../apps/e-commerce/landing/product-details.html"><img
                                                    ...
                                                    width="53" /></a></td>
                                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                                href="../../../apps/e-commerce/landing/product-details.html">Intel Core
                                                i9-11900K Desktop Processor 8 Cores up to 5.3 GHz Unlocked</a></td>
                                        <td
                                            class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            $80</td>
                                        <td
                                        ...
                                        <td class="tags align-middle review pb-2 ps-3" style="min-width:225px;"><a
                                                ...
                                                class="text-decoration-none" href="#!"><span
                                                    class="badge badge-tag me-2 mb-2">Performance</span></a><a
                                                class="text-decoration-none" href="#!"><span
                                                    class="badge badge-tag me-2 mb-2">Lifestyle</span></a>
                                        </td>
                                        <td class="align-middle review fs-8 text-center ps-4"><span
                                                class="fas fa-star text-warning"></span>
                                        </td>
                                    ...
                                    <tr class="position-static">
                                        ...
                                        <td class="align-middle white-space-nowrap py-0"><a
                                                ...
                                                href="../../../apps/e-commerce/landing/product-details.html"><img
                                                    ...
                                                    width="53" /></a></td>
                                        <td class="product align-middle ps-4"><a class="fw-semibold line-clamp-3 mb-0"
                                                href="../../../apps/e-commerce/landing/product-details.html">ASUS TUF
                                                Gaming F15 Gaming Laptop</a></td>
                                        <td
                                            class="price align-middle white-space-nowrap text-end fw-bold text-body-tertiary ps-4">
                                            $150</td>
                                        <td
                            ...
                            @else
                                <h4 class="text-center mt-5 text-danger">No Buylead Enquiries found.</h4>
                            @endif
                        </div>
                        @unless ($search)
                            <div class="mt-3">
                                ...
                                <div class="d-none d-md-block">
                                    {{ $buyleadinquiry->links('pagination::bootstrap-5') }}
                                </div>
                                <!-- Smaller pagination for mobile screens -->
                                <div class="d-md-none">
                                    {{ $buyleadinquiry->onEachSide(1)->links('pagination::bootstrap-5') }}
                                </div>
                            </div>
                        @endunless
                    </div>
