    ...
    <div class="content">
        <nav class="mb-5" style="--phoenix-breadcrumb-divider: '&gt;&gt;';" aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item active fs-sm text-dark fw-bold" aria-current="page">My Products</li>
            </ol>
        </nav>
        <div class="row gy-3 mb-4 justify-content-between">
            <div class="col-xxl-6">
                <h1 class="mb-5 text-body-emphasis fw-bolder">My Products</h1>
                                        ...
                                        <div class="d-flex align-items-center  gap-2">
                                            ...
                                            <a href="{{ route('enquiries') }}"
                                                class="text-info mt-2 fs-6 fw-bold mb-0 mb-sm-4"><span
                                                    class="fs-8 text-body lh-lg">Direct Inquiries</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="border-translucent ">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <a href="{{ route('verifybuyers-list') }}"
                                                class="text-info mt-2 fs-6 fw-bold mb-0 mb-sm-4"><span
                                                    class="fs-8 text-body lh-lg">Verified Buyers</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="border-translucent ">
                                        <div class="d-flex align-items-center  gap-2">
                                            ...
                                            <a href="{{ route('postreq-list') }}"
                                                class="text-info mt-2 fs-6 fw-bold mb-0 mb-sm-4"><span
                                                    class="fs-8 text-body lh-lg">My Buy Inquiries
                                                </span></a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="border-translucent">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <a href="{{ route('website-lead') }}"
                                                class="text-info mt-2 fs-6 fw-bold mb-0 mb-sm-4"><span
                                                    class="fs-8 text-body lh-lg">My Website Inquiries</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="border-translucent">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <a href="{{ route('realshipment-data') }}"
                                                class="text-info mt-2 fs-6 fw-bold mb-0 mb-sm-4"><span
                                                    class="fs-8 text-body lh-lg">Real ShipmentData</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
