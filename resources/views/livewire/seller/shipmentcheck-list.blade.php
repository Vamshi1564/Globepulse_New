        ...
        <div class="content m-0 p-0">
            ...
            <nav class="my-5" style="--phoenix-breadcrumb-divider: '&gt;&gt;';" aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">ShipmentCheck List</li>
                </ol>
            </nav>

            <div class="row gx-3 flex-between-end mb-5">
                <div class="col-auto">
                    <h2 class="mb-2">ShipmentCheck List</h2>
                </div>
            </div>
            ...
            <div class="row g-4 mb-5">
                @foreach ($shipmentlist as $item)
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-1 shadow-sm rounded-4 h-100 card-hover">
                            <div class="card-body d-flex flex-column justify-content-between p-4">
                                <h5 class="fw-semibold text-dark mb-0">{{ $item->title }}</h5>
